 ...
 * @version 2.3.R 2014-01-06 16:00:00Z ajeh $
 */
...
class ot_avatax {
  ...
  function install() {
    ...
    tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('AvaTax Version', 'MODULE_ORDER_TOTAL_AVATAX_VERSION', 'Basic', 'Select Basic or Pro - refer AvaTax License', '6', '3','tep_cfg_select_option(array(\'Basic\', \'Pro\'), ', now())");
    tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('AvaTax Mode', 'MODULE_ORDER_TOTAL_AVATAX_MODE', 'Development', 'Only select Production if you have completed the GO LIVE process with Avalara,Inc.', '6', '4','tep_cfg_select_option(array(\'Development\', \'Production\'), ', now())");
    tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('AvaTax Company Code', 'MODULE_ORDER_TOTAL_AVATAX_CODE', '', 'Enter the Company Code', '6', '5', now())");
    ...
    tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('AvaTax Account Number', 'MODULE_ORDER_TOTAL_AVATAX_ACCOUNT', '', 'The AvaTax Account Number', '6', '7', now())");
    tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('AvaTax License Key', 'MODULE_ORDER_TOTAL_AVATAX_LICENSE', '', 'The AvaTax License Key', '6', '8', now())");
    tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Taxable Address', 'MODULE_ORDER_TOTAL_AVATAX_ADDRESS', 'Shipping', 'Select Destination Address to use for Sales Tax', '6', '9','tep_cfg_select_option(array(\'Shipping\', \'Billing\'), ', now())");
    ...
    tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sales Tax Description', 'MODULE_ORDER_TOTAL_AVATAX_DESCRIPTION', 'Sales Tax', 'The Sales Tax description to be displayed', '6', '11', now())");
    tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Show Location Code', 'MODULE_ORDER_TOTAL_AVATAX_LOCATION', 'true', 'Include a City name in your Sales Tax description', '6', '12', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now())");
    tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Street Address', 'MODULE_ORDER_TOTAL_AVATAX_STREET', '', 'The Street your business is located in', '6', '13', now())");
